...
func AuthMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if accessURL == "" {
			log.Println("[AuthMiddleware] AUTH_ACCESS_URL not configured")
			c.AbortWithStatusJSON(http.StatusInternalServerError, gin.H{"error": "AUTH_ACCESS_URL not configured"})
			return
		}
